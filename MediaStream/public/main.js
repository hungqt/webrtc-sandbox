...
function handleError(error) {
  if (error.name === 'ConstrantNotSatisfiedNerror') {
    errorMsg('The resolution ' + constriants.video.width.exact + 'x' + constraints.video.width.exact + ' px is not supported by your device.');
